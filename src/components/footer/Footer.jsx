...
const Footer = () => {
    ...
    return (
        <div className="min-w-screen w-full bg-[#4E5152] text-white flex justify-center p-[1rem] xxs:px-[2rem] md:p-[1rem]">
    ...
    //     <div className="flex flex-col gap-[1.8rem] md:gap-[1rem] m-auto grow">
    //         <div className="md:flex md:gap-[1.8rem] md:mx-[1.8rem] 2xl:mx-[2rem] 2xl:my-[1rem] justify-between">
    //             <div className="grow md:grow-[2] md:w-fit md:m-auto">
    //                 <Subscribe />
    //             </div>
    //             <div className="hidden ml:block w-[2px] self-stretch bg-gradient-to-tr from-transparent via-neutral-400 to-transparent opacity-25 mx-auto"></div>
    //             <div className="hidden md:block md:m-auto lg:grow-[1]">
    //                 <Contact/>
    //             </div>
    ...
    //             <div className="hidden lg:block lg:m-auto lg:grow-[1]">
    //                 <Logo />
    //             </div>
    //             {/* <div className="md:flex md:w-[50%] xl:w-[60%]">
